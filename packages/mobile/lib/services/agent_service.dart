...
""";
  ...
  Future<String> _executeTool(
    ...
    try {
      switch (name) {
        ...
        case "code_stats": return "Use run_command: cloc . or scc . for code statistics.";
        ...
        case "detect_language": final ext = (args["file_path"] as String).split(".").last; return "Detected: .$ext";
        case "ascii_tree": return "Use run_command: tree -L ${args["max_depth"] ?? 3}";
        case "plantuml_render": case "mermaid_render": return "Paste at https://mermaid.live/ or https://plantuml.com/";
        case "generate_dockerfile": return "Use run_command with dockerfile templates. See: https://docs.docker.com";
        case "generate_nginx_config": return "Use run_command with nginx config templates.";
        ...
        case "git_revert": return "Use run_command: git revert ${args["hash"]}";
  ...
  Future<String> _genEnvExample(String project) async {
    final vars = <String>{};
    await _walk(project, "", (file, content) {
      for (final m in RegExp("process\\.env\\.(\\w+)|os\\.environ\\[[\"'](\\w+)[\"']]|getenv\\([\"'](\\w+)[\"']\\)|\\b(\\w+)=\\s*process\\.env").allMatches(content)) {
